DROP TABLE IF EXISTS public.daemon_flight_plan;
...
DROP TABLE IF EXISTS public.daemon_marketplace_latest;

DROP TABLE IF EXISTS public.daemon_user;

DROP TABLE IF EXISTS public.daemon_user_ship;
